...
/**
 * ManifestsActionFixture
 *
 */
class ManifestsActionFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'manifest_action' => ['type' => 'string', 'length' => '200', 'null' => false, 'default' => null, 'collate' => 'Latin1_General_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'manifest_action' => 'Lorem ipsum dolor sit amet',
