...
/**
 * ActionsCorrectiveFixture
 *
 */
class ActionsCorrectiveFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'actions_corrective';
    ...
    public $fields = [
        ...
        'action_corrective' => ['type' => 'string', 'length' => '200', 'null' => false, 'default' => null, 'collate' => 'Latin1_General_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'action_corrective' => 'Lorem ipsum dolor sit amet',
